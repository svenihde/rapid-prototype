...
public class DbFragmentInstance {
    public Boolean existFragment(int fragment_id) {
        ...
        try {
            ...
            String sql = "SELECT id FROM fragmentinstance WHERE fragment_id = " + fragment_id;
    ...
    public int getFragmentInstanceID(int fragment_id) {
        java.sql.Connection conn = Connection.getInstance().connect();
        Statement stmt = null;
        ResultSet rs = null;
        int results = -1;
